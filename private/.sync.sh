...
PATH_TARGET='~/r2d2/it/homekit/homebridge-livebox-info' # Path of script directory 
NODE_MODULE_TARGET='/usr/local/lib/node_modules/homebridge-livebox-info'
...
/usr/bin/ssh -p $PORT_TARGET $USER_TARGET@$HOST_TARGET "mkdir -p ${PATH_TARGET}/img"
...
scp -P $PORT_TARGET -rp $SRC/src/sh/homebridge-livebox-info.sh $USER_TARGET@$HOST_TARGET:$PATH_TARGET/src/sh/homebridge-livebox-info.sh
scp -P $PORT_TARGET -rp $SRC/src/sh/lbx_sysbus.py $USER_TARGET@$HOST_TARGET:$PATH_TARGET/src/sh/lbx_sysbus.py
scp -P $PORT_TARGET -rp $SRC/docs/CHANGELOG.md $USER_TARGET@$HOST_TARGET:$PATH_TARGET/docs/CHANGELOG.md
#scp -P $PORT_TARGET -rp $SRC/img/homebridge-livebox-info_screenshots.png $USER_TARGET@$HOST_TARGET:$PATH_TARGET/img/homebridge-livebox-info_screenshots.png
...
/usr/bin/ssh -p $PORT_TARGET $USER_TARGET@$HOST_TARGET "sudo mkdir -p ${NODE_MODULE_TARGET}/img"
...
scp -P $PORT_TARGET -rp $SRC/src/sh/homebridge-livebox-info.sh $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/src/sh/homebridge-livebox-info.sh
scp -P $PORT_TARGET -rp $SRC/src/sh/lbx_sysbus.py $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/src/sh/lbx_sysbus.py
scp -P $PORT_TARGET -rp $SRC/docs/CHANGELOG.md $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/docs/CHANGELOG.md
#scp -P $PORT_TARGET -rp $SRC/img/homebridge-livebox-info_screenshots.png $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/img/homebridge-livebox-info_screenshots.png
